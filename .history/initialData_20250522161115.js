...
const taskMap = {}; // Track tasks by ID
  ...
  function openModal(taskId) {
    ...
    if (taskId) {
      ...
      modal.querySelector('#modal-title').value = task.title;
      modal.querySelector('#modal-description').value = task.description;
      modal.querySelector('#modal-status').value = task.status;
      modal.dataset.taskId = taskId;
    } else {
      // Add Task Mode
      modal.querySelector('#modal-title').value = '';
      modal.querySelector('#modal-description').value = '';
      modal.querySelector('#modal-status').value = 'todo';
      delete modal.dataset.taskId; // Clear taskId for add mode
    }
  }
